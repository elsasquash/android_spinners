...
public class Spinner3Activity extends ActionBarActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<Person> adapter = new ArrayAdapter<>(this, R.layout.person_layout, R.id.textViewFirstName, getData());
    ...
    public void moveToNextScreen(View view) {
        finish();
        Intent myIntent = new Intent(this, Spinner4Activity.class);
